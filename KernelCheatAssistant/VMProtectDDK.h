...
#ifdef _WIN64
	#pragma comment(lib, "D:\\CheatAssistant\\KernelCheatAssistant\\VMProtectDDK64.lib")
#else
...
VMP_IMPORT BOOLEAN VMP_API VMProtectIsDebuggerPresent(BOOLEAN);
VMP_IMPORT BOOLEAN VMP_API VMProtectIsVirtualMachinePresent(void);
