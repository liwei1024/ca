...
public:
	...
	void registersHotKey(int hotKeyId, const char * hotKeyName);
	...
	static int decrypt(lua_State * m_L);
	...
	static int sleep(lua_State * m_L);
	static int getWindowRect(lua_State * m_L);
	...
	static int luaSwitch(lua_State * m_L);
};
